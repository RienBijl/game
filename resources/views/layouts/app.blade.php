...
<head>
    ...
    <script src="{{ asset('mdvl/rpgui.min.js') }}" defer></script>
    ...
    <!-- Styles -->
    <link href="{{ asset('mdvl/rpgui.css') }}" rel="stylesheet">
                ...
                {{--<div class="collapse navbar-collapse" id="navbarSupportedContent">--}}
                    ...
                    {{--<ul class="navbar-nav mr-auto">--}}
                        {{--@auth--}}
                            {{--@if(Auth::user()->town != null)--}}
                                {{--<li class="nav-item">--}}
                                    {{--<a class="nav-link" href="{{ url("town/" .Auth::user()->town->id) }}">{{Auth::user()->town->name}}</a>--}}
                                {{--</li>--}}
                                {{--<li class="nav-item">--}}
                                    {{--<a class="nav-link" href="{{ url("map") }}">Kaart</a>--}}
                                {{--</li>--}}
                            {{--@endif--}}
                        {{--@endauth--}}
                    {{--</ul>--}}
